                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="addtocart-button clearfix">
                                            <a class="add-to-cart" href="javascript:void(0)"
                                                onclick="AddToCard(10752,1)"><i class="fa fa-shopping-cart"></i> Mua</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="price">
                                            <span class="price-new">405.000&nbsp;₫</span>
                                        </div>
                                        <div class="addtocart-button clearfix">
                                            <a class="add-to-cart" href="javascript:void(0)"
                                                onclick="AddToCard(10771,1)"><i class="fa fa-shopping-cart"></i> Mua</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="addtocart-button clearfix">
                                            <a class="add-to-cart" href="javascript:void(0)"
                                                onclick="AddToCard(10742,1)"><i class="fa fa-shopping-cart"></i> Mua</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
