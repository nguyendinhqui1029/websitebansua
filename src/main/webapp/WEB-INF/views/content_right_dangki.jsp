	...
	<div
		...
		<form class="form-horizontal" method="POST">
			...
			<div class="form-group form-inline">
				...
				<div class="col-sm-9">
					<select class="col-md-4 form-control" placeholder="Ngày"></select>
					<select class="col-md-4 form-control" placeholder="Tháng"></select>
					<select class="col-md-4 form-control" placeholder="Năm"></select>
				</div>
			</div>
			<div class="form-group">
